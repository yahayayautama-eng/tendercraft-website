...
export const VERIFIED_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    technology: ['Chrome Extension Manifest V3', 'TypeScript', 'Tailwind CSS', 'Vite', 'Chrome Web Store'],
    status: 'production',
    statusLabel: 'Completed / Live on Chrome Web Store',
    coverImagePath: '/projects/freighthud/freighthud-hero.jpg',
    liveUrl: 'https://freighthud.vercel.app',
    storeUrl: 'https://chromewebstore.google.com/detail/obcpknlcbnkceaommkckjdnoclmgemic',
    repositoryUrl: null,
    featured: true,
    published: true,
    sortOrder: 4,
  ...
  },
  {
    ...
    summary:
      'A completed Chrome extension for contractors and purchasing teams, parsing Amazon Business, Home Depot, AliExpress, and Temu receipts into job-costed itemized splits ready for QuickBooks batch export.',
    problem:
    ...
    capabilities: [
      'Line-item extraction from Amazon Business, Home Depot, AliExpress, and Temu orders.',
    ...
    technology: ['Chrome Extension Manifest V3', 'JavaScript', 'QuickBooks IIF/CSV', 'Chrome Web Store'],
    status: 'production',
    statusLabel: 'Completed / Live on Chrome Web Store (v1.3.1)',
    coverImagePath: '/projects/cartitemizer/cartitemizer-hero.jpg',
    liveUrl: 'https://cartitemizer.vercel.app',
    storeUrl: 'https://chromewebstore.google.com/detail/cartitemizer-receipt-item/lemeifejbhckhopkcgljjoonhckdoclk',
    repositoryUrl: null,
    featured: true,
    published: true,
    sortOrder: 5,
